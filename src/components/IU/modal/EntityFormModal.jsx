              ...
              <div key={field.name} className={field.fullWidth ? 'md:col-span-2' : ''}>
                ...
                {field.type === 'select' ? (
                  <select
                    ...
                    onChange={onChange}
                    className="block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={onChange}
                      placeholder={field.placeholder || ''}
                      className="block w-full rounded-md border border-gray-300 bg-white px-3 py-2 pr-10 text-sm text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                      required={field.required !== false}
                      disabled={field.disabled}
